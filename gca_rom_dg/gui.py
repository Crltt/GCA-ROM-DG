...
def hyperparameters_selection(name, var, n):
    ...
    def default_values(name):
        if name == "maxwell":
            ...
            preset = [3, 3, 2, 2, 1, 1, 1, 2, 1]
        elif name == "maxwelldg0125":
            preset = [3, 3, 3, 2, 1, 1, 1, 2, 1]
        elif name == "maxwelldg0125p2":
            preset = [3, 3, 3, 2, 1, 1, 1, 2, 1]
        elif name == "maxwelldg0125p2hp":
            preset = [3, 3, 3, 2, 1, 1, 1, 2, 1]
        elif name == "maxwelldg00625p1hp":
            preset = [1, 3, 3, 2, 1, 1, 1, 2, 1]
        elif name == "maxwelldg00625p2hp":
            preset = [0, 1, 3, 2, 1, 1, 1, 2, 1]
        return preset
